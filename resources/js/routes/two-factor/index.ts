...
/**
* @see \App\Features\Auth\Controllers\Settings\TwoFactorAuthenticationController::show
* @see app/Features/Auth/Controllers/Settings/TwoFactorAuthenticationController.php:28
